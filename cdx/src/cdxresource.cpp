//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxresource.cpp,v $
// $Author: hebertjo $
//
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static char rcsid[] = "@(#) $Id: cdxresource.cpp,v 1.1.1.1 2000/04/22 16:10:57 hebertjo Exp $";
#endif
...
CDXResource::~CDXResource(void)
{
	if (version == 1)
	{
		...
		wchar_t wTempFile[] = L"CDX.TMP";
		DeleteFileW(wTempFile);
