//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxfile.cpp,v $
// $Author: mindcry $
//
// $Log: cdxfile.cpp,v $
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static char rcsid[] = "@(#) $Id: cdxfile.cpp,v 1.2 2000/08/21 21:16:06 mindcry Exp $";
#endif
...
int CDXFile::OpenCommon(const char* FileName, DWORD Access, DWORD Sharing, DWORD CreateDisposition)
{
	...
	std::string narrowString = FileName;
	std::wstring wideString(narrowString.begin(), narrowString.end());

	if ((m_fh = CreateFile(wideString.c_str(), Access, Sharing, NULL, CreateDisposition,
