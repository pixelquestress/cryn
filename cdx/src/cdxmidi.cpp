//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxmidi.cpp,v $
// $Author: istan $
//
// $Log: cdxmidi.cpp,v $
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static char rcsid[] = "@(#) $Id: cdxmidi.cpp,v 1.5 2000/09/10 02:41:42 istan Exp $";
#endif
...
int CDXMidi::LoadMidi(const char *name)
{
	...
	if (GetCurrentDirectoryW(_MAX_PATH, wszDir) == 0)
	{
		return -1;
	}
