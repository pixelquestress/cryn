//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxsurface.cpp,v $
// $Author: istan $
//
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static char rcsid[] = "@(#) $Id: cdxsurface.cpp,v 1.14 2000/09/08 18:29:49 istan Exp $";
#endif
...
HRESULT CDXSurface::Create(CDXScreen* pScreen, const char* szFilename, BYTE memoryType)
{
	...
	if(m_lpDDS == NULL) 
    {
	    ...
	    if((( hResInfo  = FindResource(NULL, (LPCWSTR)szFilename, RT_BITMAP)) == NULL ) ) return -2;
...
//
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSurface::ChangeFont(const char* FontName, int Width, int Height, int Attributes)
{
    HRESULT rval;
...
HRESULT CDXSurface::TextXY(int x, int y, COLORREF col, LPCTSTR pString)
{
    ...
    if(dc != NULL)
    {
	    ...
	    SetTextColor(dc, col);
	    rval = ::TextOut(dc, x, y, pString, strlen((char*)pString));
...
HRESULT CDXSurface::DrawText(LPCSTR pString, COLORREF col, LPRECT pRect)
{
    ...
    if(dc != NULL)
    {
	    SetBkMode(dc, TRANSPARENT);
	    SetTextColor(dc, col);
	    rval = ::DrawText(dc, (LPCWSTR)pString, strlen(pString), pRect, DT_WORDBREAK);
...
HRESULT CDXSurface::SaveAsBMP(const char * szFilename)
{
	...
	file_out = CreateFile((LPCWSTR)szFilename,
				          GENERIC_WRITE,
				          FILE_SHARE_WRITE,
				          NULL,
				          CREATE_ALWAYS,
