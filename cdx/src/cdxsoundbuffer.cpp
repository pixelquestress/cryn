//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxsoundbuffer.cpp,v $
// $Author: mindcry $
//
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static char rcsid[] = "@(#) $Id: cdxsoundbuffer.cpp,v 1.6 2000/08/21 21:21:28 mindcry Exp $";
#endif
...
{
	size_t newSize = strlen(narrowStr) + 1;
	wchar_t* wideStr = new wchar_t[newSize];
	size_t convertedChars = 0;
	mbstowcs_s(&convertedChars, wideStr, newSize, narrowStr, _TRUNCATE);
...
HRESULT CDXSoundBuffer::LoadFromRes(CDXSound* pDS, const char* Filename, int Num)
{
	...
	if (((hResInfo = FindResource(NULL, wideFilename.c_str(), L"WAV")) == NULL)) return DSERR_GENERIC;
