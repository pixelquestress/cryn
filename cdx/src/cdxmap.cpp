//////////////////////////////////////////////////////////////////////////////////
// $Source: /cvsroot/cdx/cdx3.0/src/cdx/cdxmap.cpp,v $
// $Author: istan $
//
// $Log: cdxmap.cpp,v $
...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static char rcsid[] = "@(#) $Id: cdxmap.cpp,v 1.8 2001/02/15 23:30:54 istan Exp $";
#endif
...
//////////////////////////////////////////////////////////////////////////////////
CDXMap::CDXMap(CDXScreen *pScreen) : m_Screen(pScreen), m_Walkable(NULL)
{
...
// CDXMap Constructor
//////////////////////////////////////////////////////////////////////////////////
CDXMap::CDXMap(CDXTile *pTiles, CDXScreen *pScreen) : m_Screen(pScreen), m_Walkable(NULL)
{
	// initialize the class so we have a fresh start
	Init();
...
void CDXMap::Init()
{
	...
	AnimatedSymbolIndex = 0;
	WalkableSymbolIndex = 0;
}
...
{
	// Calculate the right edge of the visible map area in map coordinates
	int screenRightEdge = m_PosX + m_SCREEN_W;

	// Ensure we don't return a value beyond the map's width
	return (std::min)(screenRightEdge / m_TileWidth, m_Width);
}

int CDXMap::GetScreenMapPosY2()
{
	int screenBottomEdge = m_PosY + m_SCREEN_H;
	return (std::min)(screenBottomEdge / m_TileHeight, m_Height);
}

void CDXMap::AnimateMap(int delay)
{
	...
	if (animationCounter >= delay) {
		...
		// Animate tiles 10-14 (second row, first 5 tiles)
		for (int y = 0; y < m_Height; y++) {
			for (int x = 0; x < m_Width; x++) {
				int currentTile = GetTile(x, y);
				if (currentTile >= 10 && currentTile <= 14) {
					// Cycle through the animation frames
					int nextTile = (currentTile - 10 + 1) % 5 + 10;
					SetTile(x, y, nextTile);
				}
			}
		}
	}
